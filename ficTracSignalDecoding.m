...
% handle edge case so we don't fall off the edge of the trace
...
%downSampleFactor = sampleRate / DOWN_SAMPLE_RATE;
%accumulatedPositionOut = downsample(accumulatedPositionOut, downSampleFactor);
