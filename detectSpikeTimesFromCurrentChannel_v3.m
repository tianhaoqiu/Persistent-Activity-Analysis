function [ spikeRasterOut, spikeIndexOut, spikeTimesOut ] = detectSpikeTimesFromCurrentChannel_v3(voltage, timeArray, current, currentThreshold, lowPassCutOff, highPassCutOff, sampleRate)
...
%
%    Yvette Fisher, 10/2020, updated 5/2022, updated 11/2022 by Tianhao Qiu

filteredCurrent = bandPassFilter( current, highPassCutOff, lowPassCutOff, sampleRate );
...
xlabel('seconds');
ylabel(' band-pass filtered current (pA)');
